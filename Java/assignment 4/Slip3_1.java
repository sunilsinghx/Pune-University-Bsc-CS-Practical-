/*define a class MyDate( Day,Month,year) with method to accept and display a MyDate object. Accept date as dd, mm, yyyy. Throw user defined exception “InvalidDateExeption” if the date is invalid.*/
